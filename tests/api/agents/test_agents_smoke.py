...
class TestAgentsSmoke:
    ...
    def test_get_authorized_agents(self, api_manager: ApiManager, authorized_agent: AgentResponse):
    ...
    def test_get_enabled_agents(self, api_manager: ApiManager, authorized_agent: AgentResponse):
